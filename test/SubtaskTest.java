...
class SubtaskTest {
    ...
    void addNewSubtask() {
        ...
        Subtask subtask = new Subtask("Подзадача", "Проверка создания", TaskStatus.NEW, taskManager.createEpic(epic).getId(), Duration.ofMinutes(6), LocalDateTime.of(2024,1,1,1,1));
    ...
    public void subtasksShouldBeEqualsIfIdIsEqual() {
        Task sub1 = new Subtask("Подзадача1", "Проверка равенства1", TaskStatus.NEW ,2, Duration.ofMinutes(5),LocalDateTime.of(2024, 2, 3, 3, 47));
        Task sub2 = new Subtask("Подзадача2", "Проверка равенства2", TaskStatus.DONE, 2, Duration.ofMinutes(5),LocalDateTime.of(2024, 4, 3, 3, 47));
