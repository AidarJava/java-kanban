...
//        Task task1 = new Task("Задача1", "Проверка создания1", TaskStatus.NEW,5, time1);
//        System.out.println(manager.createTask(task1));
//        LocalDateTime time2 = LocalDateTime.of(2024,2,1,7,1);
//        Task task2 = new Task("Задача2", "Проверка создания2", TaskStatus.IN_PROGRESS,4,time2);
